...
def func():
  return render_template('home.html', data=data)  #just below the route wrote the corresponding function            lhs data is the variable that will be passed into the html file for direct access
